...
import CreateSocialsResourcesModal from './CreateSocialsResourcesModal';
...
const CreateEditResourceForm = ({ resource }) => {
  ...
  const handleSocial = useCallback((data) => {
  ...
  return (
    <>
      {socialModalOpen && (
        <CreateSocialsResourcesModal
          isOpen={socialModalOpen}
          onClose={() => setSocialModalOpen(false)}
          social={social}
          setSocial={handleSocial}
        />
      )}
      <div className='w-full flex flex-col items-center justify-normal p-8'>
        ...
        <form
              ...
              {mainImage ? (
                <ToolTip label='Click Image to clear'>
                  <img
                    src={mainImage}
                    alt='Imagen Subida'
                    className='w-[300px] object-cover cursor-pointer z-10'
          ...
          <div className='flex sm:flex-col md:flex-row items-center gap-4 justify-between'>
            ...
            <div className='w-full'>
              <div className='flex items-start justify-between w-fit'>
                <label
                  htmlFor='media'
                  className='block text-sm font-medium leading-6 text-gray-900'>
                  Red Social
              ...
              <div className='mt-2 relative'>
                <button
                  type='button'
                  className='text-xs rounded-lg bg-indigo-600 py-2 px-4 text-white hover:bg-indigo-500  whitespace-nowrap'
                  onClick={(e) => {
                    e.stopPropagation();
          ...
          <div className='w-fit'>
            <div className='flex flex-col items-center mt-2'>
              <label className='block text-sm font-medium text-gray-900 self-start leading-6 '>
                Agregadas{' '}
                <span>
                  <em>(clickea en el icono para eliminar)</em>
                </span>
              </label>
